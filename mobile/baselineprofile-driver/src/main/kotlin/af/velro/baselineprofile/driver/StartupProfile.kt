package af.velro.baselineprofile.driver
...
/**
 * The driver app's cold start.
 *
 * A near-copy of the passenger generator rather than something shared: a
 * profile is a list of methods baked into one APK, so each app needs its own
 * recording pointed at its own package. The two entry points differ even
 * though everything below them is the same code.
 *
...
class StartupProfile {
    ...
    private companion object {
         ...
         */
        const val PACKAGE = "af.velro.driver"

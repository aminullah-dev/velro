...
private struct SignedInView: View {
    ...
    private func destination(_ route: Route) -> some View {
        switch route {
        case .board: BoardView(app: app)
        case .documents: DocumentsView(app: app)
        case .vehicle: VehicleView(app: app)
        case .earnings: EarningsView(app: app)
